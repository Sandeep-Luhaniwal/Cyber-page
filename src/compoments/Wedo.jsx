    ...
    return (
        <>
            <div className='position-relative'>
                ...
                <div className='myContainer position-relative z-2 overflow-hidden'>
                    <Row className='align-items-center justify-content-between'>
                        <Col md={6} className='pt-4 pt-md-0 d-flex'>
                            <div className="d-sm-grid">
                                <div className="wedo1 py-3 py-sm-0" data-aos="fade-right" data-aos-duration="1500">
                                    <img src={Wedo1} className='w-100' alt="Wedo" />
                                </div>
                                <div className="wedo2 py-3 py-sm-0" data-aos="fade-down" data-aos-duration="1500">
                                    <img src={Wedo2} className='w-100' alt="Wedo" />
                                </div>
                                <div className="wedo3 mt--24 py-3 py-sm-0" data-aos="fade-up" data-aos-duration="1500">
                                    <img src={Wedo3} className='w-100' alt="Wedo" />
                                </div>
                                <div className="wedo4 mt--24 py-3 py-sm-0" data-aos="fade-left" data-aos-duration="1500">
                                    <img src={Wedo4} className='w-100' alt="Wedo" />
                                </div>

                            </div>
                        </Col>
                        <Col md={6} lg={5} className=' py-3 py-md-0' data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
