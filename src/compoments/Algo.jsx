...
const Algo = () => {
    return (
        <>
            <div className='myContainer z-2 position-relative '>
                <Row className='align-items-center py-30 py-sm-40 pt-md-100 pt-lg-150 justify-content-between'>
                    <Col md={6} className='pt-4 pt-md-0 order-1 order-md-0'>
